...
## Results
The best performing machine learning model was the XGBoost algorithm with an F1 score of 1 on the training set and 0.95 on the validation and test sets. This model outperformed the other models, including logistic regression and support vector classifier proving that it is effective in identifying fraudulent claims. Besides, the model Interpretation analysis revealed that Vehicle Price, Policy Number, and Age of Policy holder were some of the top predictors of fraud.<br>
